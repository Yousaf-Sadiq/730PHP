            ...
            $('#step_one_next').click(function(){
               ...
               if($('#personal-info-validation').hasClass('active')){
                    ...
                    for(var i = 1; i<=tracks_count; i++){
                        ...
                        tracks_html += '<div class="col-sm-12"><div class="input-group"><input type="file" class="form-control" id="track_audio_file'+i+'" name="track_audio_file[]"><label class="input-group-text" for="track_audio_file'+i+'">Audio File</label></div></div>';
