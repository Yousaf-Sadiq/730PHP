...
<head>
    ...
    <title>Statements | Q Phonic Entertainment </title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                             <div class="col-xl-12">
                                <h6 class="text-muted">Account Statements</h6>
                                <!-- Small table -->
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table class="table table-sm">
                                                      ...
                                                      <tbody class="table-border-bottom-0">
                                                          ...
                                                          <?php 
                                                            $query = $db->query("SELECT DISTINCT(label_name) FROM statements WHERE user_id = ".$_SESSION['login_userid']);
                                                            $count =1;
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    <td><?=$count;?></td>
                                                                  <td>
                                                                      <strong><?php echo $row['label_name']; ?></strong>
                                                                  </td>
                                                                 <!-- <td><?php //echo date('F', strtotime($row['month'])); ?></td> -->
                                                                  
                                                                  <td> <?php $q = $db->query("SELECT * FROM statements WHERE label_name = '".$row['label_name']."' AND user_id = ".$_SESSION['login_userid']);
                                                                    echo mysqli_num_rows($q);
                                                                  ?></td>
                                                                  <td>
                                                                      <button type="button" class="btn btn-sm btn-primary export_btn" data-label="<?php echo $row['label_name']; ?>">Export Data</button>
                                                                  </td>
                                                                </tr>
                                                            <?php
                                                        $count++;
            ...
            $(".export_btn").click(function(){
                ...
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    // alert(item.earnings);
                    data.push([item.release,item.label,item.earnings,item.year,item.month]);
                  });
                  console
                    var csv = 'Release, Label_Name, Earnings, Year, Month\n';
