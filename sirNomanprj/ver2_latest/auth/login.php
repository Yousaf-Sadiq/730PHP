...
if(isset($_POST["email-username"])){
    ...
    $query = $db->query("SELECT * FROM admins WHERE ( admin_username = '$email_username' OR admin_email = '$email_username' ) AND admin_pass = '$password' ");
    if(mysqli_num_rows($query)!=0) {
        while($row = $query->fetch_assoc()){
            $_SESSION['admin_id'] = $row['admin_id'];
            $_SESSION['admin_name'] = $row['admin_displayname'];
...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/auth/login-basic by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Sep 2022 16:46:02 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Admin Sign in | <?php echo $global_name;  ?></title>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo $global_logo; ?>" />
...
<body>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="<?php echo $global_logo; ?>" width="100">
                                </span>
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to <?php echo $global_name; ?> Admin! 👋</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="POST">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" name="adminsubmit">Sign in</button>
                            </div>
                        </form>
    ...
    <!-- <div class="buy-now">
    <a href="././././themeselection.com/item/sneat-bootstrap-html-laravel-admin-template/index.html" target="_blank" class="btn btn-danger btn-buy-now">Buy Now</a>
  </div> -->
...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/auth/login-basic by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Sep 2022 16:46:04 GMT -->
