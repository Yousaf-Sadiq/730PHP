...
if(isset($_POST['add_artist'])){
    ...
    // echo '<pre>';
    $post_data = $_POST;
    $query = "INSERT INTO artists (artist_name, artist_realname, user_id, created_at) VALUES ('".$_POST['artist_name']."', '".$_POST['real_name']."', ".$_SESSION['login_userid'].", '".date('Y-m-d h:i:s')."')";
    // echo $query;
...
<head>
    ...
    <title>Manage Artists | Q Phonic Entertainment  </title>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
							...
							<div class="col-xxl">
								<div class="card mb-4">
									<div class="card-header d-flex align-items-center justify-content-between">
										<h5 class="mb-0">Add Artist</h5> <small class="text-muted float-end">Default label</small> </div>
									<div class="card-body">
										<form action="" method="post">
											<div class="row mb-3">
												<label class="col-sm-2 col-form-label" for="basic-default-name">Artist Name</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="basic-default-name" name="artist_name" placeholder="John Doe" required/> </div>
											</div>
											<div class="row mb-3">
												<label class="col-sm-2 col-form-label" for="basic-default-company">Real Name</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="basic-default-company" name="real_name" placeholder="ACME Inc." required/> </div>
											</div>
										
											<div class="row justify-content-end">
												<div class="col-sm-10">
													<button type="submit" name="add_artist" class="btn btn-primary">Add</button>
												</div>
											</div>
										</form>
									</div>
							...
							<div class="col-md-12">
                                ...
                                <div class="card">
                                  <h5 class="card-header">Manage Artists</h5>
                                  <div class="table-responsive text-nowrap">
                                    <table class="table">
                                      ...
                                      <tbody class="table-border-bottom-0">
                                        ...
                                        ?>
                                            <tr data-artist-row-id="<?php echo $row['artist_id']; ?>">
                                              <td>
                                                <button type="button" class="btn btn-icon btn-danger delete_artist" data-id="<?php echo $row['artist_id']; ?>">
                                              ...
                                              <td> 
                                                <strong><?php echo $row['artist_name']; ?> </strong></td>
                                              <td><?php echo $row['artist_realname']; ?> </td>
                                            </tr>
                                        <?php
                                        $count++;
                                        }
    ...
    $(document).ready(function(){
       $(".delete_artist").click(function(){
                ...
                delete_id = $(this).data("id");
                  $("tr[data-artist-row-id='"+delete_id+"']").css('background', '#ff9c9c');
                $.ajax({
                  url: "ajax_files/delete_artist.php",
                  method: "GET",
                  data: { id : delete_id },
