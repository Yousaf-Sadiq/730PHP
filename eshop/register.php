                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="cfm_pswd" name="Cfm_password" placeholder
                                        required="required">
                            ...
                            <div class="col-12">
                                <div class="form-group login-btn">
                                    <input class="btn  w-25 disabled" name="register" id="submit" type="button"
                                        value="Register">
                                    <a href="<?php echo LOGIN; ?>" class="btn">Login</a>
                                </div>
                                <div class="checkbox">
